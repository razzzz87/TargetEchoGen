...
struct qt_meta_stringdata_CLASSQwtPolarPannerENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQwtPolarPannerENDCLASS = QtMocHelpers::stringData(
    "QwtPolarPanner",
    "movePlot",
    "",
    "dx",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQwtPolarPannerENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QwtPolarPanner::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQwtPolarPannerENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQwtPolarPannerENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQwtPolarPannerENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QwtPolarPanner::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQwtPolarPannerENDCLASS.stringdata0))
