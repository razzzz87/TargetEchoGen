...
struct qt_meta_stringdata_CLASSQwtPolarMagnifierENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQwtPolarMagnifierENDCLASS = QtMocHelpers::stringData(
    "QwtPolarMagnifier",
    "rescale",
    "",
    "factor",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQwtPolarMagnifierENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QwtPolarMagnifier::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQwtPolarMagnifierENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQwtPolarMagnifierENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQwtPolarMagnifierENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QwtPolarMagnifier::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQwtPolarMagnifierENDCLASS.stringdata0))
