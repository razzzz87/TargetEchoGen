...
struct qt_meta_stringdata_CLASSSettingsEditorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSettingsEditorENDCLASS = QtMocHelpers::stringData(
    "SettingsEditor",
    "edited",
    "",
    "PlotSettings"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSettingsEditorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SettingsEditor::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSettingsEditorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSettingsEditorENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSettingsEditorENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SettingsEditor::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSettingsEditorENDCLASS.stringdata0))
