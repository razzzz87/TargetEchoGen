...
struct qt_meta_stringdata_CLASSIncrementalPlotENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSIncrementalPlotENDCLASS = QtMocHelpers::stringData(
    "IncrementalPlot",
    "showSymbols",
    ""
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSIncrementalPlotENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject IncrementalPlot::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSIncrementalPlotENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSIncrementalPlotENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSIncrementalPlotENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *IncrementalPlot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSIncrementalPlotENDCLASS.stringdata0))
