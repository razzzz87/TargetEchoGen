...
struct qt_meta_stringdata_CLASSSliderBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSSliderBoxENDCLASS = QtMocHelpers::stringData(
    "SliderBox",
    "setNum",
    "",
    "v"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSSliderBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject SliderBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSSliderBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSSliderBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSSliderBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *SliderBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSSliderBoxENDCLASS.stringdata0))
