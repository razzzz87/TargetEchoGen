...
struct qt_meta_stringdata_CLASSAttitudeIndicatorENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAttitudeIndicatorENDCLASS = QtMocHelpers::stringData(
    "AttitudeIndicator",
    "setGradient",
    "",
    "setAngle",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAttitudeIndicatorENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AttitudeIndicator::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAttitudeIndicatorENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAttitudeIndicatorENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAttitudeIndicatorENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AttitudeIndicator::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAttitudeIndicatorENDCLASS.stringdata0))
