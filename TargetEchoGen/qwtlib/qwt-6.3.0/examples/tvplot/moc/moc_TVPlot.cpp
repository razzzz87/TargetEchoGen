...
struct qt_meta_stringdata_CLASSTVPlotENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTVPlotENDCLASS = QtMocHelpers::stringData(
    "TVPlot",
    "setMode",
    "",
    "exportPlot",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTVPlotENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TVPlot::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTVPlotENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTVPlotENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTVPlotENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TVPlot::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTVPlotENDCLASS.stringdata0))
