...
struct qt_meta_stringdata_CLASSWheelBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSWheelBoxENDCLASS = QtMocHelpers::stringData(
    "WheelBox",
    "valueChanged",
    "",
    "theme"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSWheelBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject WheelBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSWheelBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSWheelBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSWheelBoxENDCLASS_t,
        // property 'theme'
...
void *WheelBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSWheelBoxENDCLASS.stringdata0))
