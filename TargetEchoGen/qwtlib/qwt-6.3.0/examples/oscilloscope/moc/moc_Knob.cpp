...
struct qt_meta_stringdata_CLASSKnobENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSKnobENDCLASS = QtMocHelpers::stringData(
    "Knob",
    "valueChanged",
    "",
    "theme"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSKnobENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject Knob::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSKnobENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSKnobENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSKnobENDCLASS_t,
        // property 'theme'
        QtPrivate::TypeAndForceComplete<QColor, std::true_type>,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<Knob, std::true_type>,
        // method 'valueChanged'
...
void *Knob::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSKnobENDCLASS.stringdata0))
