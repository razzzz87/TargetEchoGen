...
struct qt_meta_stringdata_CLASSAmplifierBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSAmplifierBoxENDCLASS = QtMocHelpers::stringData(
    "AmplifierBox",
    "setMaster",
    "",
    "v"
...
Q_CONSTINIT static const uint qt_meta_data_CLASSAmplifierBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject AmplifierBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSAmplifierBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSAmplifierBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSAmplifierBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *AmplifierBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSAmplifierBoxENDCLASS.stringdata0))
