...
struct qt_meta_stringdata_CLASSTunerBoxENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSTunerBoxENDCLASS = QtMocHelpers::stringData(
    "TunerBox",
    "fieldChanged",
    "",
    "f",
...
Q_CONSTINIT static const uint qt_meta_data_CLASSTunerBoxENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject TunerBox::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSTunerBoxENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSTunerBoxENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSTunerBoxENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *TunerBox::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSTunerBoxENDCLASS.stringdata0))
