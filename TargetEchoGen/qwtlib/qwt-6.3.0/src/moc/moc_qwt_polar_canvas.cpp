...
struct qt_meta_stringdata_CLASSQwtPolarCanvasENDCLASS_t {};
constexpr auto qt_meta_stringdata_CLASSQwtPolarCanvasENDCLASS = QtMocHelpers::stringData(
    "QwtPolarCanvas"
);
...
Q_CONSTINIT static const uint qt_meta_data_CLASSQwtPolarCanvasENDCLASS[] = {
...
Q_CONSTINIT const QMetaObject QwtPolarCanvas::staticMetaObject = { {
    ...
    qt_meta_stringdata_CLASSQwtPolarCanvasENDCLASS.offsetsAndSizes,
    qt_meta_data_CLASSQwtPolarCanvasENDCLASS,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSQwtPolarCanvasENDCLASS_t,
        // Q_OBJECT / Q_GADGET
...
void *QwtPolarCanvas::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CLASSQwtPolarCanvasENDCLASS.stringdata0))
